...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public Vector2 joystickVector2 = new Vector2(0, 0);

        private Vector2 KeyboardInput
        {
            get { return useKeyboardInput ? new Vector2(Input.GetAxis(horizontalAxis) + joystickVector2.x, (Input.GetAxis(verticalAxis)) + joystickVector2.y) : Vector2.zero; }
        }
